package github.al0046.fortyukon.worldgen;
...
import github.al0046.fortyukon.worldgen.tree.custom.PineTrunkPlacer;
...
public class ModConfiguredFeatures {
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(FortYukon.MOD_ID, name));
    }
