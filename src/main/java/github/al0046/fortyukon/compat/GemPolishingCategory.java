...
import github.al0046.fortyukon.recipe.GemPolishingRecipe;
...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(FortYukon.MOD_ID, "gem_polishing");
    public static final ResourceLocation TEXTURE = new ResourceLocation(FortYukon.MOD_ID,
    ...
    public Component getTitle() {
        return Component.translatable("block.fortyukon.gem_polishing_station");
    }
