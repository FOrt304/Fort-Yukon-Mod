...
public class BlueDragonEntity extends Animal {
    public BlueDragonEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
...
//        this.goalSelector.addGoal(1, new RhinoAttackGoal(this, 1.0D, true));
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        return ModEntities.BLUE_DRAGON.get().create(pLevel);
    }
