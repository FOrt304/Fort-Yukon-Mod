package github.al0046.fortyukon.entity.animations;
...
public class ModAnimationDefinitions {
    ...
    public static final AnimationDefinition BLUE_DRAGON_IDLE = AnimationDefinition.Builder.withLength(0.5f)
            .addAnimation("rightwing",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(-6f, 2f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
                            new Keyframe(0.25f, KeyframeAnimations.posVec(-3f, 1f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
            ...
            .addAnimation("leftwing",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            new Keyframe(0f, KeyframeAnimations.posVec(7f, -1f, 0f),
                                    AnimationChannel.Interpolations.LINEAR),
